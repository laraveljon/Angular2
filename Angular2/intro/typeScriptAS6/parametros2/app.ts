...
function evento(nombre:string,apellidoP:string,apellidoM){
  let mensaje:string;
...
function evento2(sujeto:string,numero:number=2,objeto:string="Gerra",objeto2:string="Mudial"){
let mensaje:string;
